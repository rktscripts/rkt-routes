Config = {}
Config.debug = false
Config.target = 'ox_target' -- qb-target, ox_target or false
Config.Finishkey = "F7"
Config.blipColor = 50
...
Config.Lang = {
    ['pt-br'] = {
        star_route_label = 'Iniciar rota',
        star_route_notify = 'Rota Iniciada',
        pickup_label = 'Pegar',
        route_label_progress = 'Pegando...',
        error_route_notify = 'Você já está com uma rota ativa.',
        finish_route_notify = 'Rota finalizada',
        finish_route_keymap = 'Cancelar Rota"',
        blip_route = 'Próximo Localização',
    },
    ['en'] = {
        star_route_label = 'Start Route',
        star_route_notify = 'Route Started',
        pickup_label = 'Pick up',
        route_label_progress = 'Picking up...',
        error_route_notify = 'You already have a route;',
        finish_route_notify = 'Route finished',
        finish_route_keymap = 'Cancel',
        blip_route = 'Next Route Location',
    }
}
