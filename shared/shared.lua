...
Config.Lang = {
    ...
    ['en'] = {
        star_route_label = '[E] - Start Route',
        star_route_label_target = 'Start Route',
        star_route_notify = 'Route Started',
        route_label_progress = 'Coletando...',
        error_route_notify = 'You already have an active route.',
        finish_route_notify = 'Route finished',
        finish_route_keymap = 'Cancel Route',
        blip_route = 'Next Location',
    }
}
